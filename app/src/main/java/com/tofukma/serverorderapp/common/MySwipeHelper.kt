...
abstract class MySwipeHelper(context: Context,
    ...
    abstract fun instantianteMyButton(viewHolder: RecyclerView.ViewHolder, buffer: MutableList<MyButton>)
    ...
    override fun onSwiped(viewHolder: RecyclerView.ViewHolder, direction: Int) {
        ...
        if(buttonBuffer.containsKey(swipePosition))
            ...
            buttonList!!.clear()
        buttonBuffer.clear()
        swipeThreshold = 0.5f*buttonBuffer!!.size.toFloat()*buttonWith.toFloat()
        recoverSwipedItem()
    ...
    override fun onChildDraw(
        ...
        if(actionState == ItemTouchHelper.ACTION_STATE_SWIPE)
        {
            if(dX < 0)
            {
                ...
                {
                    instantianteMyButton(viewHolder, buffer)
    ...
    private fun drawButton(c: Canvas,
                           itemView: View,
                           buffer: MutableList<MySwipeHelper.MyButton>,
                           pos: Int,
                           translationX: Float) {
